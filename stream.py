...
def build_ffmpeg_command(url, title):
    ...
    return [
        ...
        *input_options,
        ...
        "-i", OVERLAY,
        "-filter_complex",
        f"[0:v]scale=640:360:flags=lanczos,unsharp=5:5:0.8:5:5:0.0[v];"
        f"[1:v]scale=640:360[ol];"
        f"[v][ol]overlay=0:0[vo];"
        f"[vo]drawtext=fontfile='{FONT_PATH}':text='{text}':fontcolor=white:fontsize=10:x=35:y=35",
        "-r", "29.97003",
        "-c:v", "libx264",
        "-profile:v", "high",
        "-level:v", "3.2",
